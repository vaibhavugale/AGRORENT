...
const Section = ({showIndexAccordion,setEquID,setShowIndexAccordion,filterData,setShowModal,setSelectedId,setModalData}) => {
  ...
  return (
...

   {
    ...
    showIndexAccordion && filterData.map((cardData)=>{
     ...
     <Card cardData={cardData} setEquID={setEquID} setSelectedId={setSelectedId} setModalData={setModalData} setShowModal={setShowModal} />
     </motion.div>
    })
   }
